...
namespace Dhadgar.Servers.Data.Configuration;
...
///   <item><c>ix_audit_resource_time</c>: Resource-specific queries ("who touched server Z")</item>
/// </list>
/// </remarks>
public sealed class ApiAuditRecordConfiguration : IEntityTypeConfiguration<ApiAuditRecord>
{
    public void Configure(EntityTypeBuilder<ApiAuditRecord> builder)
    {
        ...
        // Resource lookup: "Who accessed server/resource Z and when"
