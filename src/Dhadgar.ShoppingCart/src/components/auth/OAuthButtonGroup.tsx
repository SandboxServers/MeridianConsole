        ...
        {providers.map((provider) => (
          <button
            ...
            className={clsx(
              ...
              isCompact
                ? 'justify-center px-3 py-3 md:px-4 md:py-4'
                : 'justify-start px-4 py-3 md:px-5 md:py-4',
          ...
          >
            {loadingProvider === provider.id ? (
              ...
              <ProviderIcon provider={provider.id} className="w-5 h-5 md:w-6 md:h-6 flex-shrink-0" />
            )}
            {!isCompact && (
      ...
      <div className="grid grid-cols-4 md:grid-cols-6 gap-3">
        {OAUTH_PROVIDERS.map((provider) => (
          <button
            ...
            disabled={loadingProvider !== null}
            className={clsx(
              'relative flex items-center justify-center px-3 py-3 md:px-4 md:py-4',
              'rounded-lg border border-glow-line/50 bg-panel-dark',
              'transition-all duration-200',
              'hover:border-text-secondary hover:bg-glow-line/20',
          ...
          >
            {loadingProvider === provider.id ? (
              ...
              <ProviderIcon provider={provider.id} className="w-5 h-5 md:w-6 md:h-6" />
            )}
          </button>
        ))}
      </div>
